...
export async function run() {
  try {
    ...
    await page.goto("https://ro-affiliate.glosspartners.com/login");

    await page.locator("input[name='username']").fill("azvntr");
    await page.locator("input[name='password']").fill("Btm$19384234234rff ");
